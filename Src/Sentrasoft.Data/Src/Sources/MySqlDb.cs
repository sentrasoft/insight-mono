...
{
	/// <summary>
	/// Represents a connection on database providers that are designed for MySQL Server.
	/// </summary>
	public sealed class MySqlDb : DbSql
	{

		#region Construct
		/// <summary>
		/// Initializes a new instance of the <see cref="Sentrasoft.Data.MySqlDb"/> class.
		/// </summary>
		public MySqlDb ()
		{
		...
		public override string ConnectionString {
			get
			{
				...
				{
					return string.Format("Server={0};Port={1};Database={2};Uid={3};Connection Timeout={4};", base.DataSource, base.Port, base.Database, base.User, base.DefaultConnectionTimeout);
				}
				else
				{
					return string.Format("Server={0};Port={1};Database={2};Uid={3};Pwd={4};Connection Timeout={5};", base.DataSource, base.Port, base.Database, base.User, base.Password, base.DefaultConnectionTimeout);
				}
			}
			set
			{
		...
		public override void Open ()
		{
			...
			base.DefaultConnection = new MySqlConnection(ConnectionString);
		...
		public override int NonQuery (string sql, Dictionary<string, object> parameters, int timeout = 0)
		{
			...
			MySqlCommand cmd = new MySqlCommand(sql, (MySqlConnection)base.DefaultConnection);
		...
		public override DataTable Fill (string sql)
		{
			...
			MySqlDataAdapter adapter = new MySqlDataAdapter(sql, (MySqlConnection)base.DefaultConnection);
			adapter.Fill(_d);
		...
		public override DbDataReader Render (string sql, Dictionary<string, object> parameters, int timeout = 0, bool multirender = false)
		{
			...
			if (multirender)
			{
				lockedConnection = new MySqlConnection(ConnectionString);
			...
			{
				if (base.RenderConnection != null) { base.RenderConnection.Close(); }
				base.RenderConnection = new MySqlConnection(ConnectionString);
				base.RenderConnection.Open();
				activeConnection = base.RenderConnection;
			}

			MySqlDataReader result;
			MySqlCommand cmd = new MySqlCommand(sql, (MySqlConnection)activeConnection);
		...
		public override void Prebuild (string sql, object editor)
		{
			...
			MySqlCommandBuilder _build = new MySqlCommandBuilder(new MySqlDataAdapter(sql, (MySqlConnection)base.DefaultConnection));
